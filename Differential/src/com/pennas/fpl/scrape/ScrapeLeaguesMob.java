...
public class ScrapeLeaguesMob {
	
	private static final String URL_LEAGUES = "http://m.fantasy.premierleague.com/my-leagues/";
	
	private Pattern p_league = Pattern.compile("<a href=\"/my-leagues/([0-9]+)/standings/\">(.+?)</a>");
	...
	private static final String LEAGUES_PRIVATE_CLASSIC = "<li data-role=\"list-divider\">Private classic leagues</li>";
	private static final String LEAGUES_PUBLIC_CLASSIC = "<li data-role=\"list-divider\">Public classic leagues</li>";
	private static final String LEAGUES_GLOBAL_CLASSIC = "<li data-role=\"list-divider\">Global leagues</li>";

	private static final String LEAGUES_PRIVATE_H2H = "<li data-role=\"list-divider\">Private Head-to-Head leagues</li>";
	private static final String LEAGUES_PUBLIC_H2H = "<li data-role=\"list-divider\">Public Head-to-Head leagues</li>";
	
	private static final String LEAGUES_END = "<li data-role=\"list-divider\">System classic leagues</li>";
