...
public class SimpleCryptoNew {
	...
	private final static byte[] key = { 13, 11, -15, 99, 109, -24, -78, -57, -51, 3, 89, 24, 56, 21, 56, 10 };
	...
	/*
	private static byte[] encryptBytes(String seed, byte[] cleartext) throws Exception {
		byte[] rawKey = getRawKey(seed.getBytes());
	...
	private static byte[] decryptBytes(String seed, byte[] encrypted) throws Exception {
		byte[] rawKey = getRawKey(seed.getBytes());
	...
	*/
	...
	private static byte[] getRawKey(byte[] seed) throws Exception {
		...
		if (android.os.Build.VERSION.SDK_INT >= App.JELLY_BEAN_4_2) {
